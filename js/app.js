...
const SA_MAIN = [
  ...
  { k: "assuranceActuelle", label: "Assurance / autre / trim (€)", t: NUM },
  ...
  res.innerHTML = `
    ...
    <div class="totals">
      <div class="tot"><span>Situation actuelle</span><b>${eur(c.saTotal / div)} <small class="unit">${perShort(STATE)}</small></b>
        <small class="tot-detail">Loyer : ${eur(c.saLoyerTotal / div)}${c.saAssuranceTotal ? ` · Assurance : ${eur(c.saAssuranceTotal / div)}` : ""} · Maintenance : ${eur(c.saMaintTotal / div)}</small></div>
